...
class AvailableCommandsPacket extends DataPacket implements ClientboundPacket{
	...
	public const ARG_TYPE_TARGET_NEW = 0x09;

	public const ARG_TYPE_FILEPATH = 0x10;

	public const ARG_TYPE_POSITION = 0x20;

	public const ARG_TYPE_EQUIPMENT_SLOTS = 0x25;
	public const ARG_TYPE_STRING = 0x26;

	public const ARG_TYPE_X_Y_Z = 0x2e;
	...
	public const ARG_TYPE_BLOCK_STATES = 0x42;
